<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="ProvaSisWeb.WebForm8" %>
...
<body>
    <form id="form1" runat="server">
           ...
           <asp:Button ID="Button2" CssClass ="fade" runat="server" style="z-index: 1; left: 45%; top: 46%; position: absolute; height: 50px; width: 200px" Text="Alterar"  OnClick="Button1_Click"/>
